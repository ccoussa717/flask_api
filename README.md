...
#### Update: day 4
<p>I have been able to create a new virtual machine called Webserver. It is a Ubuntu 16.06 LTS server. It is provisioned, and I can test the connection through ssh on the Azure portal. The ssh test says connection to the server is accepted from my IP address...still not able to ssh from my terminal.<p/>
